...
ENUM = {
  ...
  ROLES_PERMISSION: {
    'group_create': { guest: 0, user: 1, moderate: 1, 'co-organizer': 1, 'organizer': 1, 'admin': 1, 's-admin': 1},
    'group_info': { guest: 0, user: 0, moderate: 1, 'co-organizer': 1, 'organizer': 1, 'admin': 0, 's-admin': 0},
    'group_member': { guest: 0, user: 0, moderate: 0, 'co-organizer': 1, 'organizer': 1, 'admin': 0, 's-admin': 0},
    'group_remove': { guest: 0, user: 0, moderate: 0, 'co-organizer': 0, 'organizer': 1, 'admin': 1, 's-admin': 1},
    'event_CRUD': { guest: 0, user: 0, moderate: 1, 'co-organizer': 1, 'organizer': 1, 'admin': 0, 's-admin': 0},
  },
  USER_PUBLIC_FIELDS: {
  ...
  Images: {
    imagesTypes: ['image/png','image/jpg','image/gif'],
  ...
  getNameCurrentUser: function(user){
    return (user.profile ? user.profile.name : null) || "no name";
  },
  ...
  getDataFromInput: function(el){
    ...
    switch (el.attr('type')) {
      ...
      case 'file':
        ...
        value = ENUM.Images.storeImages(files);
        break;
      default:
        value = el.val().trim();
    }
